      ...
      >
        <TabPanel value={value} index={0} dir={theme.direction}>
          <div style={{ height: '75vh', margin: '-2vh' }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', height: '7vh', justifyContent: 'center' }}>
              <div style={{
                width: '7.75%', height: '100%', textAlign: 'center', backgroundColor: '#3f51b5',
                lineHeight: '7vh', borderRadius: '2vh', color: 'white'
              }}>
                O
              </div>
            </div>
          ...
          <div style={{ height: '75vh', margin: '-2vh' }}>
            <div>
              <FormControl className={classes.formControl} style={{ width: '30%' }}>
                <InputLabel id="demo-simple-select-label">Chọn kiểu gõ âm tiết</InputLabel>
                <Select
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', height: '7vh', justifyContent: 'center', marginTop: '2vh', marginBottom: '2vh' }}>
              <div style={{
                width: '7.75%', height: '100%', textAlign: 'center', backgroundColor: '#3f51b5',
                lineHeight: '7vh', borderRadius: '2vh', color: 'white'
              }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <form noValidate autoComplete="off">
                <TextField variant="outlined" style={{ minHeight: '75px', width: '100%' }} />
              </form>
            </div>
            <div>
              <div>
        ...
        <TabPanel value={value} index={2} dir={theme.direction}>
          <div style={{ height: '75vh', margin: '-2vh' }}>
            <div>
              <FormControl className={classes.formControl} style={{ width: '30%' }}>
                <InputLabel id="demo-simple-select-label">Chọn kiểu gõ từ</InputLabel>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                  value={age}
                ...
                >
                  ...
                  <MenuItem value="Gõ từ âm đầu + âm chính">Gõ từ âm đầu + âm chính</MenuItem>
                  <MenuItem value="Gõ từ âm chính + âm cuối">Gõ từ âm chính + âm cuối</MenuItem>
                  <MenuItem value="Gõ từ âm đầu + âm chính + âm cuối">Gõ từ âm đầu + âm chính + âm cuối</MenuItem>
                </Select>
              </FormControl>
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', height: '7vh', justifyContent: 'center', marginTop: '2vh', marginBottom: '2vh' }}>
            ...
            <div>
              <div>
                <Button style={{ backgroundColor: 'wheat', }}>
                  Chuyển từ mới<ArrowForwardIosIcon />
                </Button>
              </div>
            </div>
            <div>
        ...
        <TabPanel value={value} index={3} dir={theme.direction}>
          <div style={{ height: '75vh', margin: '-2vh' }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', height: '7vh', justifyContent: 'center', marginTop: '2vh', marginBottom: '2vh' }}>
              <div style={{
                width: '100%', height: '100%', textAlign: 'center', backgroundColor: '#DEDEDE',
                lineHeight: '7vh', borderRadius: '2vh', color: 'black'
              }}>
                Nước Việt Nam là một, dân tộc Việt Nam là một. Sông có thể cạn, núi có thể mòn song chân lý ấy không bao giờ thay đổi.
              </div>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <TextField variant="outlined" style={{ minHeight: '75px', width: '100vh', display: 'flex' }} />
            </div>
            <div>
              <div>
                <Button style={{ backgroundColor: 'wheat', }}>
                  Chuyển câu khác<ArrowForwardIosIcon />
                </Button>
              </div>
            </div>
            <div>
